...
@Component({
  selector: 'app-parent-guardian-tab',
  templateUrl: './parent-guardian-tab.component.html',
  styleUrls: ['./parent-guardian-tab.component.scss']
})
export class ParentGuardianTabComponent implements OnInit {
